  ...
  return (
    <footer className="bg-black text-white">
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-12 gap-8">
          ...
          <div className="col-span-5 flex flex-col gap-6">
            <div className="flex items-center">
              <img src="/Untitled design-38 copy.png" alt="EventCast" className="h-11 w-auto object-contain brightness-0 invert" />
            </div>
            <p className="text-white/50 text-[15px]">Moderni restoranų valdymo platforma.</p>
          ...
          <div className="col-span-2 col-start-8 flex flex-col gap-4">
            <p className="text-white/40 text-[13px] font-medium uppercase tracking-wider">Funkcijos</p>
            {["Grafikai ir tabeliai", "Dokumentai", "Ataskaitos", "Išmanios patvirtinimo grandinės", "Tiekėjų valdymas", "Rolės ir prieigos"].map((item) => (
          ...
          <div className="col-span-2 col-start-11 flex flex-col gap-4">
            <p className="text-white/40 text-[13px] font-medium uppercase tracking-wider">Įmonė</p>
            {["Sėkmės istorijos", "Apie mus", "Blogas", "Karjera", "Kontaktai"].map((item) => (
              <Link key={item} href="#" className="text-white/70 text-[15px] hover:text-white transition-colors">
                {item}
              </Link>
            ))}
      ...
      <div className="border-t border-white/10 px-10 py-5">
        <div className="max-w-[1600px] mx-auto flex items-center justify-between">
          <p className="text-white/30 text-[13px]">© 2025 EventCast UAB. Visos teisės saugomos</p>
          <div className="flex items-center gap-6">
      ...
      <div className="border-t border-white/5 px-10 py-8">
        <div className="max-w-[1600px] mx-auto flex flex-col gap-3">
          <p className="text-white/20 text-[11px] leading-[1.8]">
            EventCast yra darbo valdymo programinės įrangos teikėjas, skirtas restoranams ir restoranų tinklams. Platforma atitinka LT darbo kodekso, GDPR ir eIDAS reikalavimus.
          </p>
          <p className="text-white/20 text-[11px] leading-[1.8]">
            EventCast UAB yra privati ribotos atsakomybės bendrovė, registruota Lietuvos Respublikoje. Klausimams dėl platformos naudojimo, licencijų ar duomenų saugumo kreipkitės: support@eventcast.lt
          </p>
        </div>
      </div>
    </footer>
